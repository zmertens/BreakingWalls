 ...
 */
public abstract class BaseScreenController implements de.lessvoid.nifty.screen.ScreenController {
  ...
  public BaseScreenController(GameUIManager gameUIManager, GameStateService gameStateService) {
